...
//   var ddo = {
//     templateUrl: '<ol> <li ng-repeat="item in narrowCtrl.found"> {{ item.name }}        <button ng-click="narrowCtrl.onRemove({index: $index});">Remove Item</button></li></ol>',//foundItems.html',
//     scope: {
//       found: '<',
//       onRemove: '&'
//     }
